...
export default class Pokemon extends Component {
    ...
    async componentDidMount(){
        ...
        // convert Decimeters to Feet... The + 0.0001* 100)/100 is  for roundign two decimal places
        ...
        //Get Pokemon Description, Gender ratio ,Hatch Steps
    ...
    render() {
        return (
                            ...
                            <div className="col-md-6">
                                <div className="progress">
                                    ...
                                    <div className="progress-bar"
                                        ...
                                        aria-valuemin="0"
                                        aria-valuemax="100"
                                        ><small>{this.state.genderRatioMale}</small></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="card-footer text-muted">
                    Data From <a href="https://pokepai.co/" target="_blank" className="card-link">
                        Pokeapi.co
                    </a>
                </div>
        </div>
